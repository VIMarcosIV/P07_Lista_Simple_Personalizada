...
public class Adaptador extends BaseAdapter {
     // 2.- Creamos algunos atributos necesarios para esta clase
    ...
    // 4.- Este método le indica a la ListView cuantos elementos va a tener
    ...
    // 5.- Este método nos va a devolver la posicion
    @Override
    ...
    // Este método se va a ejecutar tantas veces como elementos haya en la lista.
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {

        // 9.- Creamos el elemento pelicula
